...
app.get('/school', (req, res) => {
  renderItem(req, res, {
    breadcrumbs: genBreadcrumbs(req, res),
...
app.get('/school/:year/:course', (req, res) => {
  renderItem(req, res, {
    breadcrumbs: genBreadcrumbs(req, res),
    itemsLabel: 'Items:',
    blacklist: ['u7a5']
...
app.get('/school/:year/:course/:item', (req, res) => {
  renderItem(req, res, {
    breadcrumbs: genBreadcrumbs(req, res),
    itemsLabel: 'Items:'
  });
});
app.get('/school/:year/:course/:item/:item2', (req, res) => {
  renderItem(req, res, {
    breadcrumbs: genBreadcrumbs(req, res),
    itemsLabel: 'Items:'
  });
});
// Serve interesting things.
app.get('/50shadesofspacegray', (req, res) => {
  res.redirect('https://www.ebay.com/sch/i.html?_from=R40&_trksid=p2380057.m570.l1313.TR11.TRC1.A0.H0.Xspace+gray+iphone+6s.TRS0&_nkw=space+gray+iphone+6s&_sacat=0');
});
